  ...
  return (
    <PageTransition className="min-h-screen bg-surface">
      ...
      <section className="relative min-h-screen pt-20 flex flex-col items-center justify-center overflow-hidden bg-primary">
        ...
        {/* Hero Image Layer - Centered on Screen (Desktop Only) */}
        <div className="hidden md:block fixed inset-0 z-10 flex items-center justify-center pointer-events-none overflow-hidden">
          <img
            alt="Hero visual"
