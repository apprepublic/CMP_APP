    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            ...
            <p className="font-body-md text-body-md text-on-surface-variant mt-2">Welcome back! Sign in to continue.</p>
          </div>

          {/* Login Form */}
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="font-body-sm text-body-sm text-on-surface block mb-2">Email or Phone</label>
              <input
                type="text"
                value={email}
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-outline text-secondary focus:ring-secondary" />
                <span className="font-body-sm text-body-sm text-on-surface-variant">Remember me</span>
              </label>
              <Link href="/forgot-password" className="font-body-sm text-body-sm text-secondary hover:underline">
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-secondary hover:bg-secondary-fixed text-primary font-h3 text-h3 py-4 rounded-xl transition-colors shadow-lg"
            >
              Sign In
            </button>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-background text-on-surface-variant font-body-sm">Or continue with</span>
              </div>
            </div>
      ...
      <div className="hidden lg:flex flex-1 bg-primary-container items-center justify-center p-12">
        <div className="max-w-lg text-center">
          ...
          <h2 className="font-h1 text-h1 text-on-primary mb-4">Start Earning Today</h2>
