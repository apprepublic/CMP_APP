-- Migration 0041: Store withdrawal_id in coin_transactions metadata, add approve function
...
BEGIN
  ...
  INSERT INTO coin_transactions (wallet_id, user_id, type, amount, balance_after, description, metadata)
  VALUES (p_wallet_id, p_user_id, 'WITHDRAWAL', p_coin_amount, v_new_balance, 'Withdrawal pending', jsonb_build_object('withdrawal_id', v_request_id));
...
BEGIN
  ...
  INSERT INTO coin_transactions (wallet_id, user_id, type, amount, balance_after, description, metadata)
  VALUES (v_wallet_id, v_user_id, 'REFUND', v_coin_amount, v_new_balance, 'Withdrawal rejected - coins returned', jsonb_build_object('withdrawal_id', p_request_id));
END;
$$;
