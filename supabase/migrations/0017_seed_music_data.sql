...
VALUES
  ...
  (
    's1000000-0000-0000-0000-000000000004'::uuid,
    'a1000000-0000-0000-0000-000000000002'::uuid,
    'Monday Morning',
    'monday-morning',
  ...
  (
    's1000000-0000-0000-0000-000000000005'::uuid,
    'a1000000-0000-0000-0000-000000000003'::uuid,
    'Late Hours',
    'late-hours',
  ...
  (
    's1000000-0000-0000-0000-000000000006'::uuid,
    'a1000000-0000-0000-0000-000000000003'::uuid,
    'Golden Hour',
    'golden-hour',
  ...
  (
    's1000000-0000-0000-0000-000000000007'::uuid,
    'a1000000-0000-0000-0000-000000000001'::uuid,
    'Surulere Shuffle',
    'surulere-shuffle',
  ...
  (
    's1000000-0000-0000-0000-000000000008'::uuid,
    'a1000000-0000-0000-0000-000000000002'::uuid,
    'Victoria Island',
    'victoria-island',
